...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: Arc<RwLock<String>> = Arc::new(RwLock::new("acessoremotogratis".to_owned()));
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["id.acessoremotogratis.com"];

pub const RS_PUB_KEY: &str = match option_env!("RS_PUB_KEY") {
    Some(key) if !key.is_empty() => key,
    _ => "jx4Yvt78VBU7rHWSX+MRWVwv+sUkyifQ0PECFzXhd0g=",
};
