...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the acessoremotogratis network..."),
        ...
        ("install_tip", "Due to UAC, acessoremotogratis can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install acessoremotogratis to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant acessoremotogratis \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant acessoremotogratis \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow acessoremotogratis to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [acessoremotogratis Input] service."),
        ...
        ("doc_mac_permission", "https://acessoremotogratis.com/docs/en/manual/mac/#enable-permissions"),
        ("Ignore Battery Optimizations", "Ignore battery optimizations"),
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next acessoremotogratis application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant acessoremotogratis \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant acessoremotogratis \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running acessoremotogratis."),
        ...
        ("install_cert_tip", "Install acessoremotogratis certificate"),
        ("confirm_install_cert_tip", "This is a acessoremotogratis testing certificate, which can be trusted. The certificate will be used to trust and install acessoremotogratis drivers when required."),
        ...
        ("verify_acessoremotogratis_password_tip", "Verify acessoremotogratis password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use acessoremotogratis and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_acessoremotogratis_server_pro_to_{}_tip", "Please upgrade acessoremotogratis Server Pro to version {} or newer!"),
        ("pull_group_failed_tip", "Failed to refresh group"),
        ("doc_fix_wayland", "https://acessoremotogratis.com/docs/en/manual/linux/#x11-required"),
